...
class Move(ABC):
    ...
    def __init__(self,
        ...
        self._dtype: type[np.dtype] | type[np.number] | None = None
    ...
    @abstractmethod
    def set_dtype(self,
                  dtype: type[np.dtype] | type[np.number]) -> None:
        """
    ...
    def get_proposal(self,
        ...
        Returns:
            New proposed vector x of shape (ndim,).
        """
        return self._valid_proposal(self._get_proposal(x, state))
...
class RandomStep(Move):
    ...
    def _get_proposal(self,
        ...
        return x.astype(self._dtype) + increment
...
class Metropolis(Move):
    ...
    def _get_proposal(self,
        ...
        Returns:
            New proposed vector x of shape (ndim,).
        """
        return np.random.multivariate_normal(x.astype(self._dtype), self._cov)
...
class Stretch(EnsembleMove):
    ...
    def _get_proposal(self,
        ...
        x_j = state.complementary_set[np.random.randint(0, len(state.complementary_set))].astype(self._dtype)
        # sample z
        z = self._sample_z(self._a)
        # move
        return x_j + z * (x.astype(self._dtype) - x_j)
...
class SetStretch(Stretch):
    ...
    def _get_proposal(self,
        ...
        proposal = x_j + z * (x.astype(self._dtype) - x_j)
...
# functions
def parse_moves(moves: Move | Sequence[Move] | Sequence[tuple[float, Move]],
